...
//                            });
//                } catch (NullPointerException ignored) {
//                    confirmAlert("خطا", "خطا در احراز هویت کاربر", R.drawable.ic_account_circle_white_24dp, R.color.colorRedAccent900, view -> Auth.logout(BarbershopProfileActivity.this));
//                }
//                return uploadResult;
//            }
//        });
