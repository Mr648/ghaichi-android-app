...
public class BarbershopReservationsAdabper extends RecyclerView.Adapter<BarbershopReservationsAdabper.ViewHolder> {
    ...
    public BarbershopReservationsAdabper(Context context) {
...
//
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_reserve_normal, viewGroup, false);
        return new ViewHolder(v);
//        return null;
    }
