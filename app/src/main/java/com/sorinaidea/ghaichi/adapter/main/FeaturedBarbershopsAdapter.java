...
import com.sorinaidea.ghaichi.models.BaseBarbershop;
...
public class FeaturedBarbershopsAdapter extends BaseAdapter<FeaturedBarbershopsAdapter.ViewHolder, BaseBarbershop> {


    public FeaturedBarbershopsAdapter(List<BaseBarbershop> barbershops, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        BaseBarbershop barberShop = mDataSet.get(position);
